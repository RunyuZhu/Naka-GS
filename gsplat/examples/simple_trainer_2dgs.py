...
class Runner:
    ...
    def eval(self, step: int):
        ...
        for i, data in enumerate(valloader):
            ...
            imageio.imwrite(
                f"{self.render_dir}/val_{i:04d}.JPG",
                (canvas * 255).astype(np.uint8),
                quality=getattr(self.cfg, "eval_jpg_quality", 95),
            )
            ...
            imageio.imwrite(
                f"{self.render_dir}/val_{i:04d}_median_depth_{step}.JPG",
            ...
            imageio.imwrite(
                f"{self.render_dir}/val_{i:04d}_normal_{step}.JPG",
                normals_output,
                quality=getattr(self.cfg, "eval_jpg_quality", 95),
            )
            ...
            imageio.imwrite(
                f"{self.render_dir}/val_{i:04d}_normals_from_depth_{step}.JPG",
            ...
            imageio.imwrite(
                f"{self.render_dir}/val_{i:04d}_distortions_{step}.JPG",
